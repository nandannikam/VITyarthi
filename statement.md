Problem Statement :-
  The goal is to create a simple, text-based ATM (Automated Teller Machine) simulation program in Python. This program will let users carry out basic banking transactions once they have    successfully logged in.
